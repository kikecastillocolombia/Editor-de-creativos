...
const AdjustmentPanel: React.FC<AdjustmentPanelProps> = ({ onApplyAdjustment, isLoading }) => {
  ...
  const presets = [
    ...
    { name: 'Iluminación Cálida', prompt: 'Adjust the color temperature to give the image warmer, golden-hour style lighting.' },
  ...
  return (
    <div className="w-full bg-gray-800/50 border border-gray-700 rounded-lg p-4 flex flex-col gap-4 animate-fade-in backdrop-blur-sm">
      <h3 className="text-lg font-semibold text-center text-gray-300">Aplicar un Ajuste Profesional</h3>
      ...
      <input
        ...
        placeholder="O describe un ajuste (ej. 'cambia el fondo a un bosque')"
