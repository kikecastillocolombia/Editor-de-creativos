    ...
    >
      <div className="flex flex-col items-center gap-6 animate-fade-in">
        ...
        <p className="max-w-2xl text-lg text-gray-400 md:text-xl">
          Retoca fotos, aplica filtros creativos o realiza ajustes profesionales usando simples instrucciones de texto. Sin herramientas complejas.
        </p>
        ...
        <div className="mt-6 flex flex-col items-center gap-4">
            ...
            <p className="text-sm text-gray-500">o arrastra y suelta un archivo</p>
        </div>
        ...
        <div className="mt-16 w-full">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-black/20 p-6 rounded-lg border border-gray-700/50 flex flex-col items-center text-center">
                    ...
                    <p className="mt-2 text-gray-400">Haz clic en cualquier punto de tu imagen para eliminar imperfecciones, cambiar colores o añadir elementos con precisión milimétrica.</p>
                </div>
                <div className="bg-black/20 p-6 rounded-lg border border-gray-700/50 flex flex-col items-center text-center">
                    <div className="flex items-center justify-center w-12 h-12 bg-gray-700 rounded-full mb-4">
                    ...
                    <p className="mt-2 text-gray-400">Transforma fotos con estilos artísticos. Desde looks vintage hasta brillos futuristas.</p>
                </div>
                <div className="bg-black/20 p-6 rounded-lg border border-gray-700/50 flex flex-col items-center text-center">
                    <div className="flex items-center justify-center w-12 h-12 bg-gray-700 rounded-full mb-4">
                    ...
                    <p className="mt-2 text-gray-400">Mejora la iluminación, desenfoca fondos o cambia el ambiente. Obtén resultados de calidad de estudio.</p>
                </div>
            </div>
        </div>
