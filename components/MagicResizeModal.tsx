...
const MagicResizeModal: React.FC<MagicResizeModalProps> = ({ isOpen, onClose, imageFile }) => {
  ...
  const handleDownload = () => {
      if (resultUrl) {
          ...
          link.href = resultUrl;
          link.download = `redimensionada-${selectedRatio}-${Date.now()}.png`;
        ...
        <div className="bg-gray-900 border border-gray-700 rounded-xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col shadow-2xl">
            <div className="flex justify-between items-center p-4 border-b border-gray-800 bg-gray-900">
                <h2 className="text-xl font-bold text-white flex items-center gap-2">
                    <span className="text-purple-400">✨</span> Redimensión Mágica
                </h2>
            ...
            <div className="flex-grow flex flex-col md:flex-row overflow-hidden">
                ...
                <div className="w-full md:w-1/3 p-6 border-r border-gray-800 bg-gray-800/30 flex flex-col gap-6 overflow-y-auto">
                    <div>
                        <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-3">Selecciona la Proporción</h3>
                        <div className="grid grid-cols-1 gap-3">
                            ...
                            >
                                <span className="font-medium">Cuadrado (1:1)</span>
                            ...
                            >
                                <span className="font-medium">Retrato (4:5)</span>
                            ...
                            >
                                <span className="font-medium">Historia (9:16)</span>
                    ...
                    <div className="mt-auto">
                        ...
                        >
                            {isGenerating ? 'Redimensionando...' : 'Generar Redimensión'}
                        </button>
                    </div>
                </div>
                ...
                <div className="w-full md:w-2/3 bg-black/50 p-6 flex items-center justify-center relative min-h-[400px]">
                    {isGenerating && (
                        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-black/60 backdrop-blur-sm">
                            <Spinner />
                            <p className="mt-4 text-purple-300 font-medium animate-pulse">Expandiendo tu creativo...</p>
                        </div>
                    )}
                    ...
                    {!resultUrl && !error && previewUrl && (
                        <div className="flex flex-col items-center gap-2 max-w-full h-full justify-center">
                            <p className="text-gray-500 mb-2 text-sm">Vista Previa Original</p>
